...
from saie.forms import FormLogin, FormCriarConta, FormEditarPerfil
from saie.models import Usuario
from flask_login import login_user, logout_user, current_user, login_required
import secrets
import os
from PIL import Image

lista_usuarios = ['Gabriel', 'Vinicius', 'Caio', 'Miguel','Arthur','Ravi','Bernardo','Noah','Gael','Rodrigo','Rafael','Renan','Ricardo','Luca','Cleiton']
